    ...
    <div className="pdf-bg-secondary pdf-border pdf-p-300">
      ...
      <div className="pdf-flex-col pdf-gap-300">
        ...
        <div className="pdf-flex-col pdf-gap-100">
          ...
          <div className="pdf-p-200" style={{ backgroundColor: 'var(--color-bg-primary)', border: '1px solid var(--color-border-default)' }}>
        ...
        <div className="pdf-flex-col pdf-gap-100">
          ...
          <div className="pdf-p-200" style={{ backgroundColor: 'var(--color-bg-primary)', borderRadius: '8px', boxShadow: 'var(--shadow-hardware-bevel)' }}>
        ...
        <div className="pdf-flex-col pdf-gap-100">
          ...
          <div className="pdf-p-200" style={{ backgroundColor: 'var(--color-bg-secondary)', borderRadius: '8px', boxShadow: 'var(--shadow-hardware-bevel-active)' }}>
